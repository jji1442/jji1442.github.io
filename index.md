...
- 스탯 중 약점 공격 추가 및 몽환나비의 회피율을 추가할 지 고민 중...................
...
## 2주차
작업명: 게임화면 UI의 버튼과의 상호작용

## 3주차
작업명: 전사 캐릭터, 1 스테이지 노말 몬스터 및 보스 몬스터의 stand 구현

## 4주차
작업명: 전사 캐릭터 공격 구현 및 1 스테이지 보스 몬스터 패턴 구현
...
- 1) 기본 배경화면(100%)
- 2) 설정, 가방, 스테이지, 적 체력, 재화, 타이머(100%)
- 3) 하단탭 - 성장탭, 캐릭터탭, 아이템탭, 상점탭, 보스탭(100%)

- 제작 결과
<img src="./imgs/gameProject02.1.jpg" width = 400>
<br>
