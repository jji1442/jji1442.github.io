...
- 게임화면의 중단 기준 캐릭터의 버프창은 좌측이고, 디버프창은 우측이다.
- 게임화면의 하단에는 탭들이 있다.
...
- 캐릭터가 몬스터에게 공격할 경우, 피해량 텍스트 출력한다.
- 기본피해량은 흰색 텍스트, 치명타피해량은 노란색 텍스트를 출력한다.
...
- 노말 스테이지 몬스터를 처치 시 재화를 1% 확률로 아이템을 랜덤으로 드랍한다.
...
- 보스 스테이지 이동 시, 2초 간 로딩화면이 나온 후, 게임화면으로 전환한다.
...
- 보스 스테이지에서 전투퇴장이 있다. 누르면 노말 스테이지로 이동한다.
