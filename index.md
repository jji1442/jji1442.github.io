...
- 게임화면의 우측 상단에는 (보스 스테이지에서만) 보스 타이머가, 하단에는 탭들이 있다.
...
- 성장탭의 좌측에는 이미지, 중앙에는 이미지의 설명, 우측에는 성장 비용이 있다.
...
- 보스 스테이지로 이동할 경우, 타이머가 활성화되며, 가방, 상점탭, 보스탭이 비활성화된다.

- 보스과의 전투승리/전투패배 시 각 창이 출력된다.
- 전투승리 창의 중앙에 얻은 금화량, 얻은 아이템, 돌아가기가 있다.
- 전투패배 창의 하단에 다시하기, 돌아가기가 있다.
- 다시하기 버튼을 누를 경우, 보스 스테이지를 리셋한다.
- 돌아가기 버튼을 누를 경우, 노말 스테이지로 이동한다.
...
- 보스 스테이지에서 노말 스테이지로 이동(전투퇴장)하는 버튼을 추가한다.
