...
|게임 제목|Boss Rusher(보스 러셔)|
|:----:|:----:|
|게임 장르|롤플레잉 게임, 방치형 게임|
|플랫폼|모바일|
|타겟 유저|직장인, 자영업자|
...
- 스테이지 클리어 시, 보상 자동 수령한다.(100%)
- 가방 시스템은 환생 시스템으로 변경한다.(100%)
- 환생 시, 10 스테이지 마다 전사 캐릭터 공격력 1이 증가 및 포션 준다.(100%)
- 환생 조건 미충족 시, 가이드 뜨게 설정한다.(100%)
- 캐릭터 스탯 정보창을 제작한다.(80%) 보라색 - 환생 증가량, 라임색 - 버프 증가량
- 캐릭터 능력치 적중도를 추가한다.(70%) - 스크롤 기능 오류
- 보스 회피도 추가한다.(100%)
- 공격주기(타당 공격 시간 + 공격시간 -0.1초)에서 공격속도(초당 공격 횟수 + 공격속도 1%(0.002))로 변경한다.(100%)
- 물약 텍스트 표기 및 사용 효과 변경한다.(100%)
- 금화의 가시성을 개선한다.(100%)

[작업내용]

- 가방 시스템 -> 환생 시스템 변경(100%)
- 캐릭터 능력치 정보 구현(90%) 보라색 - 환생 증가량, 라임색 - 버프 증가량
- 캐릭터 적중도 추가(70%)
- 보스 회피도 추가(100%)
- 공격주기 -> 공격속도 변경(100%)
- UI 개선(100%)
