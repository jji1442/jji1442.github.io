...
- 캐릭터의 성장 과정에서는 각 능력치의 분배가 중요한 역할을 한다. 그러나 어떤 능력치가 다른 능력치에 비해 월등하게 더 좋을 경우 대부분의 플레이어가 그 능력치만을 성장시키기 때문에, 각 능력치의 증가 효율을 비슷하게 제작하는 것이 중요하다. 이렇게 하면 플레이어들이 다양한 능력치를 성장시키게 되어, 게임의 전반적인 밸런스가 좋아지게 된다.
